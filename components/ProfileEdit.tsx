...
import { getRegisteredUsers, registerUser, checkUsernameExists, checkEmailExists } from '../services/storageService';
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const userIndex = users.findIndex(u => 
        u.username === session.username || u.email === session.email
      );
